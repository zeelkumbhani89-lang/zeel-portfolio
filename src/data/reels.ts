 ...
 * ---------------------------------------------------------------
 * NAYA REEL ADD KARNA:
 * Instagram: platform "instagram", url = https://www.instagram.com/reel/CODE/
 * YouTube:   platform "youtube",  url = https://youtube.com/shorts/CODE
 * Newest hamesha SABSE UPAR.
 * ---------------------------------------------------------------
 */
...
export interface Reel {
  /** Full reel/short permalink. */
  url: string;
  /** Short title shown under the reel. */
  title: string;
  /** Category tag. */
  theme: ReelTheme;
  /** Which platform — "instagram" (default) or "youtube". */
  platform?: ReelPlatform;
}

export const reels: Reel[] = [
  {
    url: "https://youtube.com/shorts/9N4QPV7ECBM",
    title: "Cyber awareness short — stay safe online",
    theme: "Awareness",
    platform: "youtube",
  },
  {
